...
<template>
  <article class="ck-resource-card">
...
.ck-resource-card:hover { border-color: var(--ckqa-border-strong); box-shadow: var(--ckqa-shadow-sm); }
...
<template>
  <div class="course-list-page">
    ...
    >
      <template #actions>
        <RouterLink class="course-list-page-create" to="/app/courses?action=create">
...
.course-list-page-create:hover { background: var(--ckqa-accent-strong); }
</style>
```
