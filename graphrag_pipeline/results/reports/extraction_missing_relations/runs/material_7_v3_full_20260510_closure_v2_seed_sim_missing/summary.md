...
- `run_id`：material_7_v3_full_20260510_closure_v2_seed_sim_missing
- `source_eval_dir`：`/home/sunlight/Projects/ckqa/graphrag_pipeline/results/extraction_eval/runs/material_7_v3_full_20260510_closure_v2_seed_sim`
...
| both_endpoints_present_but_not_connected | 197 | 0.3474 |
...
| belongs_to | 21 | 0 | 0 | 10 | 2 | 9 | 0 | 0 | 0.0000 |
| contains | 210 | 71 | 0 | 0 | 111 | 21 | 7 | 0 | 0.3381 |
| defined_by | 42 | 0 | 0 | 0 | 0 | 0 | 27 | 15 | 0.0000 |
| depends_on | 84 | 23 | 0 | 1 | 11 | 10 | 6 | 33 | 0.2738 |
| evaluated_by | 77 | 0 | 0 | 0 | 51 | 23 | 0 | 3 | 0.0000 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| auto_tuned | 81 | 14 | 0 | 5 | 31 | 13 | 5 | 13 | 0.1728 |
| default | 81 | 16 | 1 | 3 | 27 | 15 | 6 | 13 | 0.1975 |
| schema_aware | 81 | 13 | 0 | 2 | 25 | 14 | 7 | 20 | 0.1605 |
| schema_aware_directional | 81 | 15 | 0 | 2 | 28 | 15 | 6 | 15 | 0.1852 |
| schema_fewshot | 81 | 13 | 0 | 4 | 31 | 12 | 8 | 13 | 0.1605 |
| schema_fewshot_distilled | 81 | 15 | 0 | 3 | 27 | 15 | 8 | 13 | 0.1852 |
| schema_fewshot_distilled_v2 | 81 | 17 | 0 | 2 | 28 | 16 | 5 | 13 | 0.2099 |
...
|---|---|---|---|---|---|
| pts-0054-eaa3d01814 | m54-r01 | contains | both_endpoints_present_but_not_connected | 第十一章 多媒体操作系统 | 11.1 多媒体系统简介 |
| pts-0054-eaa3d01814 | m54-r02 | contains | both_endpoints_present_but_not_connected | 11.1 多媒体系统简介 | 媒体 |
...
| pts-0075-016a0e9b7c | m75-r01 | contains | both_endpoints_present_but_not_connected | 第七章 文件管理 | 7.1 文件和文件系统 |
| pts-0075-016a0e9b7c | m75-r02 | contains | both_endpoints_present_but_not_connected | 7.1 文件和文件系统 | 数据项 |
| pts-0075-016a0e9b7c | m75-r03 | contains | both_endpoints_present_but_not_connected | 7.1 文件和文件系统 | 记录 |
| pts-0075-016a0e9b7c | m75-r04 | contains | both_endpoints_present_but_not_connected | 7.1 文件和文件系统 | 文件 |
| pts-0049-bd80db3cdf | m49-r01 | contains | both_endpoints_present_but_not_connected | 第四章 存储器管理 | 4.5 分页存储管理方式 |
...
| pts-0046-a99abcf7ae | m46-r01 | evaluated_by | both_endpoints_present_but_not_connected | 第三章 处理机调度与死锁 | 第三章习题 |
