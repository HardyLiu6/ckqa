...
- `run_id`：material_7_v3_full_20260510_metadata_closure_missing
- `source_eval_dir`：`/home/sunlight/Projects/ckqa/graphrag_pipeline/results/extraction_eval/runs/material_7_v3_full_20260510_metadata_closure`
...
| source_endpoint_missing | 57 | 0.1005 |
| target_endpoint_missing | 148 | 0.2610 |
| both_endpoints_missing | 145 | 0.2557 |
...
| contains | 210 | 141 | 0 | 0 | 9 | 23 | 37 | 0 | 0.6714 |
| defined_by | 42 | 0 | 0 | 0 | 0 | 0 | 27 | 15 | 0.0000 |
| depends_on | 84 | 23 | 0 | 1 | 11 | 10 | 6 | 33 | 0.2738 |
| evaluated_by | 77 | 0 | 0 | 0 | 0 | 0 | 51 | 26 | 0.0000 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| auto_tuned | 81 | 24 | 0 | 5 | 3 | 7 | 22 | 20 | 0.2963 |
| default | 81 | 26 | 1 | 3 | 4 | 7 | 19 | 21 | 0.3210 |
| schema_aware | 81 | 23 | 0 | 2 | 4 | 9 | 18 | 25 | 0.2840 |
| schema_aware_directional | 81 | 25 | 0 | 2 | 3 | 9 | 21 | 21 | 0.3086 |
| schema_fewshot | 81 | 23 | 0 | 4 | 3 | 6 | 25 | 20 | 0.2840 |
| schema_fewshot_distilled | 81 | 25 | 0 | 3 | 2 | 9 | 23 | 19 | 0.3086 |
| schema_fewshot_distilled_v2 | 81 | 27 | 0 | 2 | 3 | 10 | 20 | 19 | 0.3333 |
...
| pts-0046-a99abcf7ae | m46-r01 | evaluated_by | target_endpoint_missing | 第三章 处理机调度与死锁 | 第三章习题 |
...
| pts-0046-a99abcf7ae | m46-r05 | appears_in | target_endpoint_missing | 高响应比优先调度算法 | 第三章习题 |
| pts-0066-4bacda7c7a | m66-r01 | contains | target_endpoint_missing | 第二章 进程的描述与控制 | 2.2.1 进程的定义和特征 |
| pts-0066-4bacda7c7a | m66-r02 | contains | source_endpoint_missing | 2.2.1 进程的定义和特征 | 进程 |
| pts-0066-4bacda7c7a | m66-r03 | belongs_to | target_endpoint_missing | 进程 | 2.2.1 进程的定义和特征 |
| pts-0066-4bacda7c7a | m66-r04 | appears_in | both_endpoints_missing | 进程控制块 | 2.2.1 进程的定义和特征 |
