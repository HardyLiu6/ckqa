...
def extract_text_unit_refs(
    ...
    *,
    ...
    for block in DIRECT_DATA_REF_BLOCK_RE.findall(answer or ""):
        for match in DIRECT_REF_TOKEN_RE.findall(block):
