...
-- 当前未接入真实登录/注册流程，测试用户不生成 password_hash。
...
WHERE `user_code` BETWEEN 'STU2026001' AND 'STU2026005'
   OR `user_code` BETWEEN 'TCH2026001' AND 'TCH2026005'
   OR `user_code` BETWEEN 'ADM2026001' AND 'ADM2026005';
