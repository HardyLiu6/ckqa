...
CREATE TABLE `qa_session_summaries` (
  ...
  `latest_topic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '摘要窗口解析出的最近主题',
  `latest_topic_message_range` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '最近主题来源消息范围',
  `active_topics_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '摘要窗口可用主题栈JSON',
  `semantic_state_version` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '会话语义状态版本',
  `semantic_state_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '会话语义状态JSON',
...
ALTER TABLE `qa_retrieval_logs`
  ...
  ADD COLUMN `rewrite_applied` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否应用追问改写' AFTER `context_budget_fallback_reason`,
  ...
  ADD COLUMN `routing_confidence` decimal(5,4) NULL COMMENT '智能推荐置信度' AFTER `topic_entity_lookup_duration_ms`,
...
ALTER TABLE `qa_retrieval_logs`
  ...
  ADD COLUMN `memory_governance_version` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '长期记忆治理版本，仅用于脱敏诊断' AFTER `memory_budget_fallback_reason`,
